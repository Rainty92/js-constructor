  ...
  _createClass(TitleBlock, [{
    ...
    value: function toHTML() {
      var _this$options = this.options,
          ...
          styles = _this$options.styles; // === const tag = block.options.tag ?? 'h1' , const styles = block.options.styles//
...
var ColumnsBlock = /*#__PURE__*/function (_Block3) {
  ...
  _createClass(ColumnsBlock, [{
    key: "toHTML",
    value: function toHTML() {
      var html = this.value.map(_utils.col).join(''); //col === item => col(item)//
...
}), new _blocks.ImageBlock(_image_for_constructor.default, {
  styles: {
    padding: "2rem 0",
    display: "grid",
...
}), new _blocks.ColumnsBlock(["Приложение на чистом JS, без использования библиотек", "Узнаешь, как работают принципы SOLID и ОПП в JS за один курс", "JS - это просто, интересно. Научись создавать любые UI своими руками"], {
  styles: {
...
}), new _blocks.TextBlock("this text from another model type", {
  styles: {
...
exports.model = model;
},{"./assets/image_for_constructor.png":"assets/image_for_constructor.png","./classes/blocks":"classes/blocks.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
